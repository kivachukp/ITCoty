pattern = {
    ...
    'vacancy': {
        ...
        'mex': ("ФИО", "my name", " готовим IT-специалистов", "ответы с собеседований",
                ...
                'Production technologist', 'Junior Treasurer', 'Call Center Manager', 'Patient Service Representative',
                'Executive in the Management of Public Procurement', 'Odborník na řízení Veřejných Zakázek', 'Стажер (документооборот)',
                'Менеджер частного детского сада', 'на постоянную работу юрисконсульта', 'Специалист по СТМ', 'менеджера по доходам',
                'Search Engine Evaluator', 'Appointment Setter', 'Помощник арбитражного управляющего', 'International logistics quotation',
                'Wireline Operator', 'Опуратор по каротажу скважин', 'Data Entry Clerk', 'Webinar Assistant', 'Chief Accountant',
                'Специалист по документообороту', 'quotation specialist', 'Meditation expert', '[Кк]оординатор экспедиционной программы',
                'Internet Evaluator', 'Document controller', 'Операционный директор', 'Директор по развитию', 'Carrier Compliance Associate',
                'ведущий логист', 'по организации курьерской доставки', 'Менеджер по работе с тендерами', '[Мм]енеджера по снабжению',
                'Снабженец', 'Водитель-наставник', 'Собственное СТО', '[Пп]ортной[ .,/-]', 'Finance Manager', 'Travel and Logistics Officer',
                'AR, AP [Aa]ccountant', '[Ии]сследователь (психологическая экспертиза)', 'Инженер-лаборант', 'Химическая технология неорганических веществ',
                'Compliance Officer', 'Editor-translator', 'Инженер-химик', 'Webinar Assistant', 'Водитель вилочного',
                'Material Engineer', 'видеоинженер', 'пециалист по выписке документов', 'Учитель английского в международную',
                'Монтажер роликов', 'енеджер школы парикмахеров', 'кономист отдела финансовой', 'Плавильщик', 'Стажер направления Юриспруденция',
                'Стажер в отдел проектного и инвестиционного кредитования', 'Ассистент инженера[ ,./-]', 'PRGM manager',
                'Outreach Associate', 'Appointment Setter', 'FP&A', 'Financial Planning and Analysis', 'архивариус', 'Грумер',
                'стрижки собак', 'экспресс-линька', 'Personal assistant', 'Бухгалтер по выписке ТТН', 'Опыт работы бухгалтером',
                'Выписка накладных', 'пециалист по управленческому учёту', 'слаботочных систем', 'отдела компенсаций и льгот',
                'поиск Юрист', 'legal support', 'по тестированию воды', 'Tax Specialist', 'оординатор-стажер', 'Фотограф/видеограф',
                '[ -/]мерчандайз', 'по рекламациям', 'по компенсациям и льгота', 'по регистрации лекарственных средств',
                'Field Service Technician', 'Territory Account Manager', 'установщик мебели', 'отрудник службы безопасности',
                'борщик фотоальбомов', '[ .,-/][Сс]толяр[ .,-/]', '[ .,-/][Пп]лотник[ .,-/]', 'Электромонтажник', 'юридического консалтинга',
                '[ .,-/]ПВЗ[ .,-/]', 'Прием и отправление посылок', 'Conversation Practice Partner', 'Exhibition sales agent',
                'нженер по международной кооперации', 'Водитель СЕ', '[ .,-/][Гг]рузчик[ .,-/]', 'водители -международники',
                'Legal Counsel', 'Бухгалтер - стажер', 'Инженер по ТБ', 'Стажер экономист', 'экономист/бухгалтер', 'Finance Control Trainee',
                'инженера-электрика', 'в диспетчерской компании', 'Consumer Healt', 'в медицинский отдел', 'Стажер-разметчик',
                'Field Specialist ESP', 'Полевой специалист УЭЦН', 'Клипмейкер', 'Логист (стажер)', 'должность: БУХГАЛТЕР',
                'Document Compilation Supervisor', 'Front Desk Agent', 'checks in guest', 'Internet Ads Assessor', 'Russian to English Translator',
                'Стажёр (ЖКХ)', 'Стажер, Юридическая служба', 'Guest Relation Manager', 'Визовый менеджер', 'Автослесарь',
                'Финансовый специалист', 'Export Control', 'documents for shipment', 'Бухгалтер (стажер)', 'Licensed Therapist',
                'Telehealth Counseling', 'Курьер на', 'Продавец в магазин', 'В отдел Оптовых продаж', 'Менеджер по бронированию',
                'Office Specialist', 'требуется логист', 'подбор транспортных средств', 'отгрузки товара', 'Начальник смены',
                'менеджер (стажер) в турагентство', 'без опыта работы в туризме', 'менеджера по туризму', 'Стажер (автомобильный бизнес)',
                'Стажер отдела качества', 'решение вопросов по бухгалтерскому учету', 'Стажер-экономист', 'Стажёр в банк',
                'Специалист по сертификации', 'Ночной Менеджер объекта', 'Менеджер объекта', 'Менеджера объекта', 'Billing specialist',
                'Foreign economic activity', 'Billing specialist', 'Сборщик корпусной', 'Пекарь[ -(]стажер', 'Бухгалтер (стажер)',
                'French [Tt]eacher', 'Junior finance', '[Bb]usiness controller', 'в отдел электроснабжения', 'Travel sales agent',
                'Учитель математики', 'Техник-смотритель', 'режиссер монтажа', 'Менеджер по коммуникации с поставщиками',
                'Личный ассистент', 'General Legal Counsel', 'travel administrator', 'Начальник организационного отдела',
                'Фасовщик', 'Personal Assistant', 'инженер ПТО', 'Procurement coordinator', 'Диспетчер аварийной службы',
                'архивист', 'Compliance Officer', 'Управляющий сетью кофеен', 'группа совершенствования налоговой', 'Автоэлектрик',
                'Водитель гримвагена', 'Переводчика со знанием', 'Accounts Payable', 'local bookkeeping', 'Chief Accountant',
                'контроля качества товаров', 'Correspondente jurídico', 'Каменщик', 'менеджер образовательных проектов',
                'Legal adviser', 'Юрисконсульт', 'Водитель на автомобиле компании', 'Стажер в Юридический отдел', 'Стажер по проверке воды',
                'Стажер в юридическую фирму', 'Электромонтажник', 'Департамента охраны труда и экологии', 'Логист (junior)',
                'дилер-стажер', '[ .,-/)][Кк]рупье[ .,-/(]', 'Диспетчер логист', 'Cупервайзер по работе с дебиторской задолженностью',
                'Помощник (стажер) в бухгалтерию', 'Стажер видеооператора', 'Экономист-бухгалтер', 'Специалист по документообороту',
                'ремонтом бытовой', 'Адвокат в Коллегию Адвокатов', 'Tenant Site Manager', 'Косметолог-эстетист', 'Медицинская сестра',
                'Медицинский брат', 'Ассистент стоматолога', 'сопровождения строительных проектов', 'Механик-стажер'),
        'mex2': (),
        'mincl': (),
    },
...
#     # capitalize
    'hr': {
        'ma': ("Human Resources Officer", " HR", "recruter", "кадр", "human r", "head hunter", "Кадр", "HR BP",
               ...
               "специалист по подбору персонала","HCM","ресерчер", 'C&B', 'People Partner', 'в отдел персонала'),
        'ma2': (),
...
#     # capitize
    ...
    'sales_manager': {
        ...
        'mdef': ("Специалист по продажам", "Менеджер по развитию бизнеса", "менеджер по развитию", "менеджер по работе с клиентами",
                 "[Hh]ead of [Ss]ales", 'Sales Администратор'),
    ...
    'junior': {
        ...
        'mex': ("не готовы рассматривать", "джуниоров пока не рассматриваем","Junior не рассматриваем",
                ...
                'от трех лет', '5 years', '3+ years', '2 - 5 Years', '5 Years', '2 years’ experience', 'вице-президент',
                'Менеджер склада', 'образцов готовой продукции', 'направления [Фф]инансы[ ,./-:;!]', '[Ff]inancial [Cc]ontroller',
                'регистратора недвижимости', '[Рр]адиомонтер', '[Ff]inance [Mm]anager', '[Mm]ental [Hh]ealth [Tt]echnician',
                '[Сс]пециалист по работе с недвижимостью', '[Аа]ссистент [Лл]аборатории', '[Ll]awyer', 'legal corporate support',
                'lawyer with practical', 'corporate law', 'international law', 'в финансовый департамент', '[Ee]nter financial transcriptions',
                '[Pp]repare bank deposits', '[Ii]ssue invoices', '[Vv]ideo [Ee]ditor', 'VP/Vice President of Product', 'требуется Руководитель',
                'Solution Architect', 'Head of payment services', 'от 1.5 лет', 'Lead Information Security Engineer', 'Агроном-стажер',
                '10+ years of', '5+ years of'),
        'mex2': (),
        'mincl': ()
    },
